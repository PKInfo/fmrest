...
class AuthAPI {
    ...
    login() {
        ...
        // requires that "amazon-cognito-identity-js": "^3.2.7" be installed with npm
        ...
        //         authenticationData
        //     );
        //     const poolData = { UserPoolId: this.cognitoPool, ClientId: this.cognitoClient };
