...
class AuthAPI {
     ...
     * @param {string} obj.encodedUserAndPassword - base64 encoded username:password authorization token
     * @param {string} obj.layout - layout
     */
    constructor({ encodedUserAndPassword, host, database, layout }) {
        this.database = database;
        this.host = host;
        this.layout = layout;
        this.url = `https://${host}/fmi/data/vLatest/databases/${database}/sessions`;
    ...
    login() {
        ...
        return rp({
            ...
            method: 'POST',
            headers: {
                Authorization: `Basic ${this.encodedUserAndPassword}`,
